...
export function Memory(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF(publicPath('/models/dalithe_persistence_of_memory.glb')) as GLTFResult
  return (
...
useGLTF.preload(publicPath('/models/dalithe_persistence_of_memory.glb'))

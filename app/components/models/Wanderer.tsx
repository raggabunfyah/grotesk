...
export function Wanderer(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF(publicPath('/models/wanderer_above_the_sea_of_fog.glb')) as GLTFResult
  return (
...
useGLTF.preload(publicPath('/models/wanderer_above_the_sea_of_fog.glb'))
